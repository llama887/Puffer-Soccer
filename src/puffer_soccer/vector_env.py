...
def make_sharded_puffer_env(
    ...
    return make_puffer_env(
        ...
        warm_start_reward_shaping=warm_start_reward_shaping,
        shaping_distance_penalty=shaping_distance_penalty,
        shaping_touch_bonus=shaping_touch_bonus,
        shaping_velocity_bonus=shaping_velocity_bonus,
